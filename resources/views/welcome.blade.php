...
<body class="antialiased bg-stone-50 text-stone-800 selection:bg-amber-600 selection:text-white">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                <div class="flex-shrink-0 flex items-center gap-3">
                    <img src="{{ asset('images/logo.png') }}" alt="Artisan Platform Logo"
                        class="h-10 w-auto rounded shadow-sm">
                    <span
                        class="font-heading font-bold text-2xl tracking-tight text-stone-900">{{ config('app.name', 'ArtisanPlatform') }}</span>
                </div>
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <a href="#features"
                        ...
                        It Works</a>
                    <a href="#about"
                        class="text-sm font-bold tracking-wider text-stone-600 hover:text-amber-700 transition uppercase">About
                        Us</a>
                    <a href="#contact"
    ...
    <section id="home" class="relative pt-32 pb-20 lg:pt-48 lg:pb-32 bg-pattern border-b border-stone-200">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            <div
                class="inline-flex items-center gap-2 px-4 py-1.5 border border-amber-800/20 text-amber-800 text-sm font-bold tracking-widest uppercase mb-8 bg-amber-50/50">
            ...
            <p class="mt-6 text-xl text-stone-600 max-w-2xl mx-auto mb-12 leading-relaxed">
                Whether you need a master carpenter, a precise electrician, or a creative painter, our platform connects
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center max-w-3xl mx-auto mb-16">
                ...
                <div class="flex justify-center mb-8">
                    <img src="{{ asset('images/logo_animation.gif') }}" alt="Artisan Logo Animation"
                        class="h-48 w-auto">
                </div>
                ...
                <p class="text-lg text-stone-600">We make it simple to hire the right person for the job while
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="bg-stone-50 p-10 border border-stone-200 hover:border-amber-700 transition-colors group">
                    <div
                        class="w-16 h-16 bg-stone-200 rounded flex items-center justify-center mb-6 group-hover:bg-amber-100 transition-colors">
                        <svg class="w-8 h-8 text-stone-700 group-hover:text-amber-700" fill="none" stroke="currentColor"
                            viewBox="0 0 24 24">
                    ...
                    <p class="text-stone-600 leading-relaxed">Browse profiles, read reviews from your neighbors, and
                        compare portfolios to choose the perfect artisan for your specific needs.</p>
                </div>
                <!-- Card 2 -->
                <div class="bg-stone-50 p-10 border border-stone-200 hover:border-amber-700 transition-colors group">
                    <div
                    ...
                    <p class="text-stone-600 leading-relaxed">Contact artisans directly through our platform, discuss
                        project details, and schedule appointments at your convenience.</p>
                </div>
                <!-- Card 3 -->
                <div class="bg-stone-50 p-10 border border-stone-200 hover:border-amber-700 transition-colors group">
                    <div
                    ...
                    <p class="text-stone-600 leading-relaxed">We focus on building a sustainable, non-profit ecosystem
                        that uplifts local workers and provides fair opportunities for everyone.</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="lg:flex items-center justify-between gap-16">
                <div class="lg:w-2/3 mb-12 lg:mb-0">
                    ...
                    <p class="text-stone-300 text-lg leading-relaxed mb-6 font-light">
                        We are a small group of passionate students who believe in the power of local communities and
                        genuine craftsmanship. We noticed how difficult it was for talented, independent artisans to
                        find consistent work, and how hard it was for people to find trustworthy help for their homes.
                    </p>
                    <p class="text-stone-300 text-lg leading-relaxed mb-10 font-light">
                        That's why we decided to build this non-profit artisan platform. Our goal isn't to make money
                        from hardworking professionals; our goal is strictly to provide a free tool that brings our
                        community closer together, empowering skilled workers to thrive while helping neighbors get the
                        job done right.
                    </p>
                    <div class="border-l-4 border-amber-600 pl-6 py-2">
                        <p class="font-heading text-2xl font-bold text-white mb-1 italic">"Built by students, for the
                            community."</p>
                        <p class="text-stone-400 font-bold tracking-widest uppercase text-sm mt-3">Non-Profit Initiative
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section id="contact" class="py-24 bg-stone-100">
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="text-lg text-stone-600 max-w-xl mx-auto mb-12">
                Whether you're an artisan wanting to join, or a community member with questions, we would love to hear
                from you.
            </p>
            ...
            <div class="bg-white p-10 border border-stone-200">
                ...
                <div class="mb-10">
                    ...
                    <a href="mailto:hello@artisanplatform.org"
                        class="font-heading text-2xl md:text-3xl font-bold text-stone-900 hover:text-amber-700 transition-colors">
                ...
                <div>
                    ...
                    <div class="flex items-center justify-center gap-6">
                        <a href="#"
                            class="w-12 h-12 border border-stone-300 text-stone-600 rounded flex items-center justify-center hover:bg-stone-900 hover:text-white hover:border-stone-900 transition-all">
    ...
    <footer class="bg-stone-900 border-t border-stone-800 py-12 text-stone-400">
        <div
            ...
            <div class="flex items-center gap-3">
                ...
                <span
                    class="font-heading font-bold text-xl text-stone-100">{{ config('app.name', 'ArtisanPlatform') }}</span>
            </div>
