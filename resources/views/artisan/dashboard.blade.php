                ...
                <a href="{{ route('booking.artisan.show', $job->id) }}" class="block glass-card rounded-lg bg-white dark:bg-stone-900/90 shadow-sm dark:shadow-none p-4 mb-4 border-l-4 border-l-amber-500 dark:border-l-amber-600 transition-transform hover:-translate-y-1 hover:shadow-md cursor-pointer group">
                    ...
                    <div class="flex items-center gap-2 mb-3 border-b border-stone-100 dark:border-stone-800 pb-3">
                        @if($job->user->profile_pic)
                            <img src="{{ asset('storage/' . $job->user->profile_pic) }}" alt="Profile" class="w-6 h-6 rounded-full object-cover border border-stone-200 dark:border-stone-700">
                        @else
            ...
            <div class="kanban-col rounded-lg p-4 h-full min-h-[400px]">
                ...
                <a href="{{ route('booking.artisan.show', $job->id) }}" class="block glass-card rounded-lg bg-white dark:bg-stone-900/90 shadow-sm dark:shadow-none p-4 mb-4 border-l-4 {{ $job->status === 'rejected_by_client' ? 'border-l-red-500 dark:border-l-red-600' : 'border-l-stone-500' }} transition-transform hover:-translate-y-1 hover:shadow-md cursor-pointer group">
                    ...
                    <div class="flex items-center gap-2 mb-2">
                        @if($job->user->profile_pic)
                            <img src="{{ asset('storage/' . $job->user->profile_pic) }}" alt="Profile" class="w-5 h-5 rounded-full object-cover border border-stone-200 dark:border-stone-700">
                        @else
